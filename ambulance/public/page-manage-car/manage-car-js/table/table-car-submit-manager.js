...
import { showAddModal } from '/modal-add-car.js';
import { showUpdateModal } from '/modal-update-car.js';
import { deleteCar } from '/modal-delete-car.js';
import { refreshTable } from '/table-car-contents.js';
import { isItemActive, getRowData } from '/table-car-utils.js';
...
async function handleEdit(id) {
    try {
        ...
        await showUpdateModal(id, rowData.license_plate);
    } catch (error) {
